...
private LocalDate checkout;
    ...
    public RoomBookingEntity(String cname, int cage, String caadhaar, long contact, LocalDate checkin, LocalDate checkout,String email,String roomtype,String password) {
        this.cname = cname;
        this.cage = cage;
